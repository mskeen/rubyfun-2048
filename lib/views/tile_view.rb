class TileView
  ...
  TILE_UI = {
    0 =>    { color: 0xff404040, back_color: Gosu::Color.argb(0xff606060), font_factor: 1.00 },
    2 =>    { color: 0xff404040, back_color: Gosu::Color.argb(0xffeee4da), font_factor: 1.00 },
    4 =>    { color: 0xff404040, back_color: Gosu::Color.argb(0xffede0c8), font_factor: 1.00 },
    8 =>    { color: 0xffffffff, back_color: Gosu::Color.argb(0xfff2b179), font_factor: 1.00 },
    16 =>   { color: 0xffffffff, back_color: Gosu::Color.argb(0xfff59563), font_factor: 1.00 },
    32 =>   { color: 0xffffffff, back_color: Gosu::Color.argb(0xfff67c5f), font_factor: 1.00 },
    64 =>   { color: 0xffffffff, back_color: Gosu::Color.argb(0xfff65e3b), font_factor: 1.00 },
    128 =>  { color: 0xffffffff, back_color: Gosu::Color.argb(0xffedcf72), font_factor: 0.80 },
    256 =>  { color: 0xffffffff, back_color: Gosu::Color.argb(0xffedcc61), font_factor: 0.80 },
    512 =>  { color: 0xffffffff, back_color: Gosu::Color.argb(0xffedc850), font_factor: 0.80 },
